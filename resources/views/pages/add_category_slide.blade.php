                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" value="1" name="open_new_tab"> Open new tab
                            ...
                            <div class="form-group @if($errors->has('ecammall_category_banner')) has-error @endif ecammall_category_banner">
                                ...
                                <p class="help-block">Image size for Big Banner should be (282px x 460px) | Image size for Middle Banner should be (282px x 153px)|Image size for Small Banner should be (180px x 180px)</p>
                            ...
                            <div class="form-group @if($errors->has('horizontal_shop_page')) has-error @endif horizontal_shop_page">
                                ...
                                <p class="help-block">Image side should be (835px x 150px)</p>
