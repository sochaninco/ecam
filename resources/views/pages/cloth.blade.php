@extends('layouts.app')
@section('title','Clothes Zone')
@section('content')
    <section id="advertisement">
        <div class="container no-padding">
                <?php
                $Product_banner = \App\CategorySlide::where(['status'=>0,'slide_type'=>10,'category_id'=>5])->get();
                ?>
    ...
    <div class="container white-bg">
        <div class="row">
            ...
            @foreach($clothBrand as $brands)
                <?Php
                    $countBrand = \App\ShopProduct::where('brand',$brands->id)->count();
                ?>
            @if($countBrand)
            ...
            @endforeach
            <div class="clearfix"></div>
            <h2 class="title text-center"> Clothes By SubCategory</h2>
            @foreach($clothSubcategory as $subcategory)
                <?php
                    $countClothSub = \App\ShopProduct::where('sub_category_id',$subcategory->id)->count();
                ?>
                @if($countClothSub > 3)
                <div class="col-sm-3 padding-bottom text-center">
