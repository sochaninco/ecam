...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Theme Shop</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            {!! Form::model($theme,['method'=>'POST','files'=>true,'role'=>'form']) !!}
                            <div class="form-group @if($errors->has('shop_type')) has-error @endif">
                                {!! Form::label('shop_type','Shop Type*',['class'=>'control-label col-sm-4']) !!}
                                <div class="col-sm-8">
                                    {!! Form::text('shop_type',null,['class'=>'form-control','placeholder'=>'Enter any shop type']) !!}
                            ...
                            <div class="form-group @if($errors->has('theme_banner')) has-error @endif">
                                ...
                                <div class="col-sm-8">
                                    <img src="{{asset('images/theme-shop/'.$theme->theme_banner)}}" class="img-responsive">
                                    <br>
                            ...
                            <div class="form-group @if($errors->has('theme_banner_small')) has-error @endif">
                                ...
                                <div class="col-sm-8">
                                    <img src="{{asset('images/theme-shop/'.$theme->theme_banner_small)}}" class="img-responsive">
                                    <br>
